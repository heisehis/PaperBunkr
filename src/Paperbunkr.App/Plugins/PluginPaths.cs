...
/// <summary>Path helper for installed plugins (docs/superpowers/specs/2026-08-24-plugin-api-v2-design.md §2), mirroring <see cref="Services.ThemePaths"/>'s convention: <c>%AppData%\Paperbunkr\plugins\&lt;plugin-key&gt;\</c>, one <c>plugin.xml</c> + script files per plugin.</summary>
