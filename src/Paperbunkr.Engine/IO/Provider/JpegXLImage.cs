...
namespace cYo.Projects.ComicRack.Engine.IO.Provider
{
    ...
    public static class JpegXLImage
    {
        ...
        // Written fresh for Paperbunkr (docs/onboarding.md §2/§4): CE hardcoded the ".dll"
        // extension into JxlLibrary below and relied on default OS search paths finding it next
        // to the exe. Registering a DllImport resolver here decouples "where jxl actually lives"
        // from the P/Invoke declarations, without changing any of the struct/enum/function shapes.
        public static class NativeMethods
        {
            private const string JxlLibrary = "jxl";

            static NativeMethods()
            {
                Native.NativeInterop.RegisterResolver(typeof(NativeMethods).Assembly, JxlLibrary);
            }
