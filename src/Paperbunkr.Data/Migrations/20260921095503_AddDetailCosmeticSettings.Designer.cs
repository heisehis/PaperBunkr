...
namespace Paperbunkr.Data.Migrations
{
    ...
    [Migration("20260921095503_AddDetailCosmeticSettings")]
    partial class AddDetailCosmeticSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Paperbunkr.Data.ComicVine.Scraping.ComicVineMatchMemoryEntry", b =>
                {
                    ...
                    b.HasIndex("Provider", "SearchKey", "ChosenVolumeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.AcquisitionSettings", b =>
                {
                    ...
                    b.Property<DateTime?>("PullListRefreshedAt")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.AppSettings", b =>
                {
                    ...
                    b.Property<int>("AutoBackupMinIntervalHours")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(4);
                    ...
                    b.Property<string>("BooksSortDirection")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                        .HasColumnType("TEXT")
                        .HasDefaultValue("Ascending");

                    b.Property<string>("BooksSortField")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                        .HasColumnType("TEXT")
                    ...
                    b.Property<bool>("ExportedListsContainFilenames")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(false);
                    ...
                    b.Property<string>("LibraryGridCoverFit")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(32)
                        .HasColumnType("TEXT")
                    ...
                    b.Property<double>("LibraryPreviewPanelWidth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("REAL")
                        .HasDefaultValue(320.0);

                    b.Property<string>("LibraryRecentSearches")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("NumericRatingThumbnails")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(true);
                    ...
                    b.Property<bool>("RestoreSessionOnStartup")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                        .HasDefaultValue(true);
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.Collection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<bool>("IsAutoCover")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("IssueSmartListId")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int?>("NovelSmartListId")
                        .HasColumnType("INTEGER");

                    b.Property<int?>("SeriesSmartListId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("IssueSmartListId");

                    b.HasIndex("NovelSmartListId");

                    b.HasIndex("SeriesSmartListId");

                    b.ToTable("Collections");
                });

            modelBuilder.Entity("Paperbunkr.Data.Entities.CollectionItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("CollectionId", "IssueId")
                        .IsUnique()
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.ContinuityCharacterLookupNegativeCache", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.ContinuityMembership", b =>
                {
                    ...
                    b.HasIndex("ContinuityId", "SeriesId")
                        .IsUnique();

                    b.ToTable("ContinuityMemberships");
                });

            modelBuilder.Entity("Paperbunkr.Data.Entities.ContinuitySuggestionDismissal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("SeriesId", "WikidataQid")
                        .IsUnique();
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.IssuePage", b =>
                {
                    ...
                    b.Property<string>("SpreadPosition")
                        .HasMaxLength(16)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.MediaRelation", b =>
                {
                    ...
                    b.ToTable("MediaRelations", t =>
                        {
                            t.HasCheckConstraint("CK_MediaRelation_OneSourceTarget", "((\"SourceSeriesId\" IS NOT NULL) + (\"SourceCollectionId\" IS NOT NULL)) = 1");

                            t.HasCheckConstraint("CK_MediaRelation_OneTargetTarget", "((\"TargetSeriesId\" IS NOT NULL) + (\"TargetCollectionId\" IS NOT NULL)) = 1");
                        });
                });
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.PluginSettingState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.ReadingEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.SeriesActivityEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.SmartListConditionGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("SmartListConditionGroups");
                });
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.StoryEventVerificationNegativeCache", b =>
                {
                    ...
                    b.HasIndex("ArcName", "Publisher", "Source")
                        .IsUnique();
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.WatchedSeries", b =>
                {
                    ...
                    b.HasIndex("Provider", "ExternalVolumeId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.Collection", b =>
                {
                    b.HasOne("Paperbunkr.Data.Entities.SmartList", "IssueSmartList")
                        .WithMany()
                        .HasForeignKey("IssueSmartListId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Paperbunkr.Data.Entities.SmartList", "NovelSmartList")
                        .WithMany()
                        .HasForeignKey("NovelSmartListId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Paperbunkr.Data.Entities.SmartList", "SeriesSmartList")
                        .WithMany()
                        .HasForeignKey("SeriesSmartListId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("IssueSmartList");

                    b.Navigation("NovelSmartList");

                    b.Navigation("SeriesSmartList");
                });
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.CollectionItem", b =>
                {
                    ...
                    b.HasOne("Paperbunkr.Data.Entities.Collection", "Collection")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.ContinuityMembership", b =>
                {
                    ...
                    b.HasOne("Paperbunkr.Data.Entities.Series", "Series")
                        .WithMany("ContinuityMemberships")
                        .HasForeignKey("SeriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.SmartListCondition", b =>
                {
                    b.HasOne("Paperbunkr.Data.Entities.SmartListConditionGroup", "Group")
                        .WithMany("Conditions")
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.SmartListConditionGroup", b =>
                {
                    b.HasOne("Paperbunkr.Data.Entities.SmartListConditionGroup", "ParentGroup")
                    ...
                    b.HasOne("Paperbunkr.Data.Entities.SmartList", "SmartList")
                        .WithOne("RootGroup")
                        .HasForeignKey("Paperbunkr.Data.Entities.SmartListConditionGroup", "SmartListId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Paperbunkr.Data.Entities.Series", b =>
                {
                    ...
                    b.Navigation("ContinuityMemberships");
