...
- **Reader (§B):** magnifier/loupe, sharpen/AutoContrast/WhitePoint image adjustment,
  type-to-jump-to-page. (Clock/battery overlay and split-page part navigation shipped 2026-09-05;
  tiled background texture mode and a per-page manual Near/Far double-page override shipped
  2026-09-11 — see the two rows above. CE's *paper texture drawn over the page image itself*,
  distinct from the canvas-background texture we built, is still a genuine gap.)
