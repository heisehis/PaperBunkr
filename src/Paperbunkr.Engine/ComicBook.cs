...
namespace cYo.Projects.ComicRack.Engine
{
    ...
    public class ComicBook : ComicInfo, IImageKeyProvider, ICloneable
    {
        ...
        {
            // TODO(Paperbunkr): WinForms Clipboard.SetDataObject() stripped during the net8 retarget.
            // Original behavior: cloned this ComicBook (minus Id/UnparsedElements), serialized to
            // ComicInfo XML, and pushed it onto the clipboard as both plain text and a native
            // ClipboardFormat payload for cross-instance copy/paste of comic metadata.
            // Needs an Avalonia clipboard (Avalonia.Input.Platform.IClipboard) equivalent at the UI layer.
        }
